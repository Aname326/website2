...
export const StateProvider = ({children}) => {
    const [lang, setLang] = useState({
      ...
      Facebook: "Auckland Catholic Chinese Community Facebook",
      February: "February",
      HA: "Hearts Alight",
      Instagram: "Hearts Alight Instagram",
      Intro: "Introduction",
    ...
    const clickEng = () => {
      setLang({
        ...
        November: "November",
        NumberAdults: "Number of Adults",
        NumberChildren: "Number of Children (14 under)",
        October: "October",
        Password: "Password",
        RegName: "Register under This Name:",
        RegisterName: "Registered Name",
